...
> = {
  "Tashkent city": { aqi: 235, status: "Good", pollutant: "PM2.5" },
  "Namangan region": { aqi: 95, status: "Moderate", pollutant: "PM10" },
  "Tashkent region": { aqi: 193, status: "Moderate", pollutant: "PM2.5" },
  "Fergana region": { aqi: 244, status: "Moderate", pollutant: "PM10" },
  "Andijan region": { aqi: 105, status: "Moderate", pollutant: "PM2.5" },
  "Syrdarya region": { aqi: 214, status: "Moderate", pollutant: "PM2.5" },
  "Jizzakh region": { aqi:202, status: "Moderate", pollutant: "PM10" },
  "Navoi region": { aqi: 107, status: "Good", pollutant: "PM2.5" },
  "Samarkand region": {
    aqi: 248,
  ...
  "Surkhandarya region": { aqi: 153, status: "Moderate", pollutant: "PM10" },
  "Bukhara region": { aqi:207, status: "Moderate", pollutant: "PM2.5" },
  "Khorezm region": { aqi: 145, status: "Moderate", pollutant: "PM10" },
